    ...
    public class WebRequestFuncitons
    {
        ...
        internal static void GetMyFHorseData(string jsonStr)
        {
            ...
            if (code.Equals("200"))
            {
                ...
                if (index > 1)
                {
                    ...
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.detailFront + "/" + UserInfoManager.NowHorseList[1].id, WebRequestFuncitons.GetHorseDetailData, true, "{}", RFrameWork.instance.token);
                }
                else
                {
                    UserInfoManager.NowHorseList.Clear();
        ...
        internal static void bookBreedSiteMaternal(string jsonStr)
        {
            ...
            if (code.Equals("200"))
            {
                ...
                ////webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.breedSiteConfigUrl, WebRequestFuncitons.SetBreedSiteConfig, true, "{}", RFrameWork.instance.token);
            }
            else
            {
                RFrameWork.instance.OpenCommonConfirm("提示", jsonData["errorMsg"].ToString(), () => { }, null);
        ...
        internal static void CheckHorseNum(string jsonStr)
        {
            ...
            if (code.Equals("200"))
            {
                ...
                if (num > 0)
                {
                    ...
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.checkRole, WebRequestFuncitons.CheckRole, true, "{}", RFrameWork.instance.token);
                }
                else
                {
        ...
        internal static void CheckRole(string jsonStr)
        {
            ...
            if (code.Equals("200"))
            {
                ...
                {
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.breedSiteConfigUrl, WebRequestFuncitons.GetBreedSiteConfig, true, "{}", RFrameWork.instance.token);
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.myPhotoUrl, WebRequestFuncitons.SendToken, true, "{}", RFrameWork.instance.token);
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.listFrontUrl, WebRequestFuncitons.GetMyHorsesList, true, "{}", RFrameWork.instance.token);
                }
                else
                {
                    //webrequestmananger.instance.AsyncLoadUnityWebRequest(WebRequestUtils.breedSiteConfigUrl, WebRequestFuncitons.GetBreedSiteConfig, true, "{}", RFrameWork.instance.token);
